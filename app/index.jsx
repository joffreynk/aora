    ...
    <SafeAreaView className='bg-primary min-h-[85vh] ' >
      <ScrollView contentContainerStyle={{height: '100%'}} >
        <View className='w-full justify-center items-center h-full px-4'>
          ...
          <Text className={`text-sm font-pregular text-gray-100 mt-7 text-center`}>Where creativity meets innovation: embark on a journey of limitless exploaration with Aora</Text>
